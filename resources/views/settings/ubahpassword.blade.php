                ...
                @php $z=Session::get('id') @endphp
                    ...
                    <form method="POST" action="/updateprofile">
                        ...
                        <div class="col-md-6 input-group">
                            <input type="text" name="nama_admin" id="nama_admin" class="form-control @error('nama_admin') is-invalid @enderror" value="" readonly>
                            @error('nama_admin')
                    ...
                    <div class="form-group row">
                        ...
                        <textarea type="text" class="form-control @error('alamat_admin') is-invalid @enderror" 
                             rows="3" name="alamat_admin" id="alamat_admin" readonly></textarea>
                             @error('alamat_admin')
                                        <span class="invalid-feedback" role="alert">
                                            <strong><font size="2">{{ $message }} </font></strong>
                                        </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 input-group">
                            <input  type="number" name="telp_admin" id="telp_admin" class="form-control @error('telp_admin') is-invalid @enderror" value="" readonly>
                            @error('telp_admin')
                                        <span class="invalid-feedback" role="alert">
                                            <strong><font size="2">{{ $message }} </font></strong>
                                        </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 input-group">
                            <input  type="email" name ="email_admin" id="email_admin" class="form-control @error('email_admin') is-invalid @enderror" value="" readonly> 
                            @error('email_admin')
                                        <span class="invalid-feedback" role="alert">
                                            <strong><font size="2">{{ $message }} </font></strong>
                                        </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 input-group">
                            <input  type="text" name="username_admin" id="username_admin" class="form-control @error('username_admin') is-invalid @enderror" value="" readonly>
