            ...
            <div class="modal-dialog" role="document">
                ...
                <form method="post" action="{{ url('/pesanan-pelanggan-store') }}">
                        ...
                        <div class="form-group">
                            ...
                            id="deskripsi" placeholder="Deskripsi Pesanan" name="deskripsi" value="{{ old('deskripsi') }}" required>
                        </div>
         ...
         @endif 
                    ...
                    <td>
                            ...
                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                ...
                                <div class="form-group">
                                    <input type="text" class="demo-code-preview form-control mt-1" 
                                    id="deskripsi" placeholder="Deskripsi Pesanan" name="deskripsi" value="{{ $po->DESKRIPSI_CATATAN_PRE_ODER_PELANGGAN }}" required>
                                </div>
                            ...
                            <a href="/data-service-pelanggan-print/{{ $po->ID_CATATAN_PRE_ORDER_PELANGGAN }}">
